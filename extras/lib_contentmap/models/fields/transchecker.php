...
class JFormFieldTranschecker extends JFormField
	...
	protected function getLabel()
		...
		$msg_skel =
			...
			'Language files for %s language are still %s. We offer a ContentMap commercial license to language contributors. <a href="http://www.opensourcesolutions.es/index.php?option=com_content&view=article&id=21&lang=en" target="_blank">Learn more.</a>' .
			'</span>' .
			'</div>';
