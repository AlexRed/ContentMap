...
window.addEvent('domready',function()
{
    ...
    //  mygeoposition.com non funziona ed ho tolto il tasto per calcolare le coordinate
	//  var picker = new Element('button',{'id':'contentmap_picker','class':'contentmap_picker','type':'button','onclick':'lookupGeoData();','html':'<img src="../media/contentmap/images/map-1666.png" />'});
