...
(function(){
  ...
  var imgBase = '../modules/mod_contentmap/img/';
  var upperImgBase = '../modules/mod_contentmap/img/';
  var shadowServer = '../modules/mod_contentmap/img/';
  ...
  function loadfunc() {
    ...
    EZMap.prototype.initParse = function() {
      ...
      if( this.extentMarker ) {
        ...
        center = new GLatLng( 41.895466, 12.482324 );
        zoomLevel = 5;
      }
